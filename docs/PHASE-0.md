...
| Prototype | Public task prototype available for sessions | `prototype/` | Passed: [mibvendor.io](https://mibvendor.io) is the production origin; rights-aware module catalog, licensed raw downloads, local walk decoding, dependency states, and the 50,000-line baseline are deployed. The expanded device-identity workbench is a tested v0.4 release candidate until its tag, deployment, and public smoke evidence are reconciled. |

...
| Rights | Viable approved Tier A/B seed plus one vendor path | `docs/research/rights/` | Passed under ADR 0008: 702 active modules from 12 redistributable sources; 20 directory-only sources and 14 RFC candidates remain excluded |
...
| Prototype | Public task prototype available for sessions | `prototype/` | Passed: [mibvendor.io](https://mibvendor.io) is the production origin; rights-aware module catalog, licensed raw downloads, local walk decoding, PEN/sysObjectID intelligence, dependency states, and 50,000-line baseline verified |
